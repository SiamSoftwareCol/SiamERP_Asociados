...
<div class="container">
    <div class="error">
        <h1>500</h1>
        <p><strong>Oops...</strong> Algo salió mal en nuestro sistema.</p>
    ...
    <div class="stack-container">
        ...
        <!-- Footer fijo -->
        <footer class="footer">
            <img src="{{ asset('images/LogoSiam.png') }}" height="40" width="40" alt="">
            <p>© 2025 SIAM ERP. Todos los derechos reservados.</p>
        </footer>
    </div>
