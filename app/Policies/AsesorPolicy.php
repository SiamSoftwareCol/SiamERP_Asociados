...
class AsesorPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Asesor');
    }
    ...
    {
        return $user->checkPermissionTo('view Asesor');
    }
    ...
    {
        return $user->checkPermissionTo('create Asesor');
    }
    ...
    {
        return $user->checkPermissionTo('update Asesor');
    }
