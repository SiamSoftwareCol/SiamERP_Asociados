...
class AportePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Aporte') || $user->canview == 'asociado';
    }
    ...
    {
        return $user->checkPermissionTo('view Aporte') || $user->canview == 'asociado';
    }
    ...
    {
        return $user->checkPermissionTo('create Aporte');
    }
    ...
    {
        return $user->checkPermissionTo('update Aporte');
    }
