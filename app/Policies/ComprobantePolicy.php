...
class ComprobantePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Comprobante');
    }
    ...
    {
        return $user->checkPermissionTo('view Comprobante');
    }
    ...
    {
        return $user->checkPermissionTo('create Comprobante');
    }
    ...
    {
        return $user->checkPermissionTo('update Comprobante');
    }
