...
class ProfesionPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Profesion');
    }
    ...
    {
        return $user->checkPermissionTo('view Profesion');
    }
    ...
    {
        return $user->checkPermissionTo('create Profesion');
    }
    ...
    {
        return $user->checkPermissionTo('update Profesion');
    }
     ...
     */
    public function replicate(User $user, Profesion $profesion): bool
    {
