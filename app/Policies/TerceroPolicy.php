...
class TerceroPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Tercero');
    }
    ...
    {
        return $user->checkPermissionTo('view Tercero');
    }
    ...
    {
        return $user->checkPermissionTo('create Tercero');
    }
    ...
    {
        return $user->checkPermissionTo('update Tercero');
    }
