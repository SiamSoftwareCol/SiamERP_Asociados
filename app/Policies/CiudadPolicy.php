...
class CiudadPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Ciudad');
    }
    ...
    {
        return $user->checkPermissionTo('view Ciudad');
    }
    ...
    {
        return $user->checkPermissionTo('create Ciudad');
    }
    ...
    {
        return $user->checkPermissionTo('update Ciudad');
    }
