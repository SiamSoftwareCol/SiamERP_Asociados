...
use App\Filament\Clusters\ReportesSuperSolidaria\Resources\F9034Resource\Pages;
use App\Filament\Clusters\ReportesSuperSolidaria\Resources\F9034Resource\RelationManagers;
use App\Filament\Exports\InformeF9034Exporter;
...
class F9034Resource extends Resource
{
    protected static ?string $model = F9034::class;
    protected static ?string $navigationIcon = 'heroicon-o-currency-dollar';
    protected static ?string $cluster = ReportesSuperSolidaria::class;
    protected static ?string $navigationLabel = 'Erogaciones directivos (F_9034)';
    protected static ?string $modelLabel = 'F_9034 - Erogaciones directivos';
    ...
    {
        return $table
            ->heading('F9034 - Relación de erogaciones a directivos')
            ->description('Relación de pagos, beneficios o erogaciones entregados a directivos, en cumplimiento de prácticas de transparencia.')
            ->paginated(false)
            ->striped()
            ...
            ->headerActions([
                Action::make('Actualizar Vista')
                    ...
                    ->action(function (array $data): void {
                            ...
                            DB::statement("SELECT public.formato_f9034(?, ?)", [
                                $fechaCorte->format('Y'),
                ...
                ExportAction::make()
                    ...
                    ->exporter(InformeF9034Exporter::class)
                    ->fileName(fn (Export $export): string => "Formato_F_9034_-{$export->getKey()}.csv")
    ...
    {
        return [
            'index' => Pages\ListF9034S::route('/'),
            'create' => Pages\CreateF9034::route('/create'),
            'edit' => Pages\EditF9034::route('/{record}/edit'),
        ];
    }
