...
class BalancePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Balance');
    }
    ...
    {
        return $user->checkPermissionTo('view Balance');
    }
    ...
    {
        return $user->checkPermissionTo('create Balance');
    }
    ...
    {
        return $user->checkPermissionTo('update Balance');
    }
