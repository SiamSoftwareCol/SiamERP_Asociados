...
class BancoPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Banco');
    }
    ...
    {
        return $user->checkPermissionTo('view Banco');
    }
    ...
    {
        return $user->checkPermissionTo('create Banco');
    }
    ...
    {
        return $user->checkPermissionTo('update Banco');
    }
