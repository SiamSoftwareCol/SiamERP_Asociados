...
class ActividadEconomicaPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any ActividadEconomica');
    }
    ...
    {
        return $user->checkPermissionTo('view ActividadEconomica');
    }
    ...
    {
        return $user->checkPermissionTo('create ActividadEconomica');
    }
    ...
    {
        return $user->checkPermissionTo('update ActividadEconomica');
    }
