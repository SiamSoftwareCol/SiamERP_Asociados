...
use App\Filament\Clusters\ReportesSuperSolidaria\Resources\F9052Resource\Pages;
use App\Filament\Clusters\ReportesSuperSolidaria\Resources\F9052Resource\RelationManagers;
use App\Filament\Exports\InformeF9052Exporter;
...
class F9052Resource extends Resource
{
    protected static ?string $model = F9052::class;
    protected static ?string $navigationIcon = 'heroicon-o-credit-card';
    protected static ?string $cluster = ReportesSuperSolidaria::class;
    protected static ?string $navigationLabel = 'Creditos de Bancos (F_9052)';
    protected static ?string $modelLabel = 'F_9052 - Creditos de Bancos';
    ...
    {
        return $table
            ->heading('F9052 - Creditos de Bancos Y Otras Obligaciones Financieras')
            ->description('Informa el detalle de la cartera de créditos de la entidad, incluyendo saldos, garantías y clasificación por tipo de deudor.')
            ->paginated(false)
            ->striped()
            ...
            ->headerActions([
                Action::make('Actualizar Vista')
                    ...
                    ->action(function (array $data): void {
                            ...
                            DB::statement("SELECT public.formato_f9052(?, ?)", [
                                $fechaCorte->format('Y'),
                ...
                ExportAction::make()
                    ...
                    ->exporter(InformeF9052Exporter::class)
                    ->fileName(fn (Export $export): string => "Formato_F_9052_-{$export->getKey()}.csv")
    ...
    {
        return [
            'index' => Pages\ListF9052S::route('/'),
            'create' => Pages\CreateF9052::route('/create'),
            'edit' => Pages\EditF9052::route('/{record}/edit'),
        ];
    }
