...
namespace App\Filament\Asociado\Pages\Auth;
...
class LoginAsociado extends OtpLogin
{
    ...
    public function verifyCode(): void
    {
        ...
        if (!$user) {
            throw ValidationException::withMessages([
                'data.username' => __('filament-otp-login::translations.validation.invalid_user'),
            ]);
        }

        $code = OtpCode::whereCode($this->data['otp'])->whereEmail($user->email)->first();
    ...
    public function generateCode(): void
    {
        ...
        } while (OtpCode::whereCode($code)->whereEmail($user->email)->exists());
