...
class BeneficiarioPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Beneficiario');
    }
    ...
    {
        return $user->checkPermissionTo('view Beneficiario');
    }
    ...
    {
        return $user->checkPermissionTo('create Beneficiario');
    }
    ...
    {
        return $user->checkPermissionTo('update Beneficiario');
    }
