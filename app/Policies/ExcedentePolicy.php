...
class ExcedentePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Excedente');
    }
    ...
    {
        return $user->checkPermissionTo('view Excedente');
    }
    ...
    {
        return $user->checkPermissionTo('create Excedente');
    }
    ...
    {
        return $user->checkPermissionTo('update Excedente');
    }
