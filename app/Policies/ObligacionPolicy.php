...
class ObligacionPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Obligacion') || $user->canview == 'asociado';
    }
    ...
    {
        return $user->checkPermissionTo('view Obligacion') || $user->canview == 'asociado';
    }
    ...
    {
        return $user->checkPermissionTo('create Obligacion');
    }
    ...
    {
        return $user->checkPermissionTo('update Obligacion');
    }
     ...
     */
    public function replicate(User $user, Obligacion $obligacion): bool
    {
