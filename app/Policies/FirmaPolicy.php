...
class FirmaPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Firma');
    }
    ...
    {
        return $user->checkPermissionTo('view Firma');
    }
    ...
    {
        return $user->checkPermissionTo('create Firma');
    }
    ...
    {
        return $user->checkPermissionTo('update Firma');
    }
     ...
     */
    public function replicate(User $user, Firma $firma): bool
    {
